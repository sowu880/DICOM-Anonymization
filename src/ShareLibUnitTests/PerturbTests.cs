...
namespace De.ID.Function.Shared.UnitTests
{
    public class PerturbTests
    {
        ...
        public void GivenAValueString_WhenPerturbFixedSpan_PerturbedValueShouldBeReturned(string value, PerturbSetting perturbSetting, decimal lowerBound, decimal upperBound)
        {
        ...
        public void GivenADecimal_WhenPerturbFixedSpan_PerturbedValueShouldBeReturned(decimal value, PerturbSetting perturbSetting, decimal lowerBound, decimal upperBound)
        {
            var result = PerturbFunction.Perturb(value, perturbSetting);
        ...
        public void GivenADouble_WhenPerturbFixedSpan_PerturbedValueShouldBeReturned(double value, PerturbSetting perturbSetting, double lowerBound, double upperBound)
        {
            var result = PerturbFunction.Perturb(value, perturbSetting);
            Assert.InRange(result, lowerBound, upperBound);
        ...
        public void GivenAnInteger_WhenPerturbFixedSpan_PerturbedValueShouldBeReturned(int value, PerturbSetting perturbSetting, int lowerBound, int upperBound)
        {
            var result = PerturbFunction.Perturb(value, perturbSetting);
            Assert.InRange(result, lowerBound, upperBound);
            Assert.True(GetDecimalPlaces(result) <= perturbSetting.RoundTo);
        ...
        public void GivenAnUnsignedInteger_WhenPerturbFixedSpan_PerturbedValueShouldBeReturned(uint value, PerturbSetting perturbSetting, uint lowerBound, uint upperBound)
        {
            var result = PerturbFunction.Perturb(value, perturbSetting);
            Assert.InRange(result, lowerBound, upperBound);
            Assert.True(GetDecimalPlaces(result) <= perturbSetting.RoundTo);
        ...
        [Theory]
        [MemberData(nameof(GetIntegerToPerturb))]
        public void GivenShortInteger_WhenPerturbFixedSpan_PerturbedValueShouldBeReturned(short value, PerturbSetting perturbSetting, short lowerBound, short upperBound)
        {
            var result = PerturbFunction.Perturb(value, perturbSetting);
            Assert.InRange(result, lowerBound, upperBound);
            Assert.True(GetDecimalPlaces(result) <= perturbSetting.RoundTo);
        ...
        [Theory]
        [MemberData(nameof(GetUnsignedIntegerToPerturb))]
        public void GivenAnUnsignedShortInteger_WhenPerturbFixedSpan_PerturbedValueShouldBeReturned(ushort value, PerturbSetting perturbSetting, ushort lowerBound, ushort upperBound)
        {
            var result = PerturbFunction.Perturb(value, perturbSetting);
            Assert.InRange(result, lowerBound, upperBound);
            Assert.True(GetDecimalPlaces(result) <= perturbSetting.RoundTo);
        ...
        [Theory]
        [MemberData(nameof(GetIntegerToPerturb))]
        public void GivenALongInteger_WhenPerturbFixedSpan_PerturbedValueShouldBeReturned(long value, PerturbSetting perturbSetting, long lowerBound, long upperBound)
        {
            var result = PerturbFunction.Perturb(value, perturbSetting);
            Assert.InRange(result, lowerBound, upperBound);
            Assert.True(GetDecimalPlaces(result) <= perturbSetting.RoundTo);
        ...
        [Theory]
        [MemberData(nameof(GetUnsignedIntegerToPerturb))]
        public void GivenAnUnsignedLongInteger_WhenPerturbFixedSpan_PerturbedValueShouldBeReturned(ulong value, PerturbSetting perturbSetting, ulong lowerBound, ulong upperBound)
        {
            var result = PerturbFunction.Perturb(value, perturbSetting);
            Assert.InRange(result, lowerBound, upperBound);
            Assert.True(GetDecimalPlaces(result) <= perturbSetting.RoundTo);
